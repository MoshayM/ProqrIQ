    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div
          ...
          style={{ background: 'radial-gradient(circle, rgba(232,92,26,0.12) 0%, transparent 70%)' }}
        />
        <div
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2.5">
            <div
              ...
              style={{ background: 'linear-gradient(135deg, #e85c1a, #c94d10)' }}
            >
              P
            </div>
          ...
          <p className="text-blue-400 text-sm mt-1.5 ml-11 opacity-80">
        ...
        <div className="relative z-10 space-y-7">
          <div>
            <h1 className="text-5xl font-extrabold text-white leading-[1.15] tracking-tight">
              ...
              <span style={{ color: '#e85c1a' }}>Cost Quotes</span>
            </h1>
            <p className="text-blue-200 mt-4 text-[15px] leading-relaxed max-w-[22rem] opacity-80">
              Upload part drawings, query your engineering knowledge base, and generate
              structured cost breakdowns with 98% confidence — entirely on-premise.
            </p>
          </div>
        ...
        <div className="w-full max-w-[340px]">
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-350 text-gray-400" />
                <input
                  id="email"
                  type="email"
                  autoComplete="email"
                  ...
                  {...register('email')}
                  className="w-full border border-gray-200 rounded-lg pl-10 pr-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e2d4e] focus:border-transparent transition-all"
                />
              </div>
              {errors.email && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  {...register('password')}
                  className="w-full border border-gray-200 rounded-lg pl-10 pr-10 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e2d4e] focus:border-transparent transition-all"
                />
                <button
                  type="button"
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 text-white py-3 rounded-lg font-semibold text-sm transition-all disabled:opacity-60 disabled:cursor-not-allowed mt-1 shadow-md hover:shadow-lg"
          ...
          <div className="mt-7 p-4 bg-gray-50 rounded-xl border border-gray-100">
            ...
            <div className="space-y-2">
              {[
                { label: 'Email',    value: 'admin@autoquote.com' },
                { label: 'Password', value: 'AutoQuote2024!'      },
              ].map(({ label, value }) => (
                <div key={label} className="flex items-center justify-between gap-3">
                  <span className="text-xs text-gray-400 w-16 shrink-0">{label}</span>
                  <code className="text-xs bg-white border border-gray-200 px-2 py-1 rounded-md text-gray-700 font-mono truncate">
                    {value}
                  </code>
                </div>
              ))}
